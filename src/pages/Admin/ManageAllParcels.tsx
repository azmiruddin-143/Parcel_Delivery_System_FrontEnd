...
// // আপনার API রেসপন্স ডেটার ধরন (type) সংজ্ঞায়িত করুন
// type Parcel = {
//     _id: string;
//     id: string;
//     trackingId: string;
...
//         case "In Transit":
//         case "Picked":
//             return "default"; // Or any other appropriate variant
//         default:
//             return "outline";
//     }
// };
...
//                         <DropdownMenuItem onClick={() => alert(`View details for ${parcel.trackingId}`)}>
//                             View Details
//                         </DropdownMenuItem>
//                         <DropdownMenuSeparator />
...
//                                 {/* Pass the parcel and the handler function to the form */}
//                                 <StatusUpdateForm
//                                     parcel={parcel}
